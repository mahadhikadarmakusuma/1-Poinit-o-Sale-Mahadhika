                            ...
                            <div class="row border-dark">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Nama kaetgori <small class="text-normal">*Maximal 30 characters</small></label>
                                        <input type="text" value="<?php echo $edit['nama_kategori'] ?>" onkeyup="checkLetter()" id="nama_kategori" class="form-control" name="nama_kategori" placeholder="nama kategori" required="" maxlength="30" aria-required="true">
                                    </div>
                                </div>
                            </div>
