...
<div class="col-md-12">
    <div class="card border-info text-dark">
        <div class="card-block">
            ...
            <button data-toggle="modal" data-target="#modal-lg" class="btn btn-sm btn-primary">TAMBAH KATEGORI</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="form-1-2" class="col-md-2 control-label">NAMA KATEGORI<small class="text-normal">*Max 30 char</small></label>
                    <div class="col-md-10">
                        <input type="text" id="nama_kategori" onkeyup="checkLetter()" class="form-control" name="nama_kategori" placeholder="nama_kategori" required="" maxlength="30">
                    </div>
                </div>
            </div>
