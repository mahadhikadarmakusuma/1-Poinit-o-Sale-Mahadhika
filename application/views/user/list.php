...
<div class="col-md-12">
    <div class="card border-success text-dark">
        <div class="card-block">
            ...
            <?php echo anchor('User/rule', 'RULE USER', array('class' => 'btn btn-sm btn-info btn-danger')) ?>
            <div class="float-right"><button data-toggle="modal" data-target="#modal-lg" class="btn btn-sm btn-danger btn-primary">TAMBAH USER</button></div>
