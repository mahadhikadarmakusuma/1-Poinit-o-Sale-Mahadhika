                ...
                <div class="col-md-8 ml-auto mr-auto">
                    ...
                    <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_barang" id="nama_barang" class="form-control" readonly=""  placeholder="masukkan nama barang">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Satuan</label>
                                <input type="text" class="form-control" name="satuan" id="barang_satuan" readonly="" placeholder="satuan">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Masukkan Belanjaan</label>
...
<script type="text/javascript">
    function selesai(){
       ...
       var kd_barang=$("#kd_barang").val();
        $.ajax({
             ...
             swal("Berhasil!", "Sukses belanja", "success");
             cetak_laporan()
             load_data_tempt();
             }
           });   
    ...
    function cancel(id){
        $.ajax({
             ...
             data: 'no_faktur='+id,
             success: function (html) {
              swal("Berhasil!", "Tidak jadi belanja", "success");   
               load_data_tempt()
             }
           });
    }
