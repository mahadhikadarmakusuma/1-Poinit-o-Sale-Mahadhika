...
<div class="card border-info text-dark">
    ...
    <h4 class="card-title">Data Barang</h4>
        ...
        <?php echo anchor('Dokumentasi', 'KEMBALI', array('class' => "btn btn-danger btn-danger")) ?>
        <button type="button" class="btn btn-primary right" data-toggle="modal" data-target="#exampleModalLong">
            upload barang file dari excel
        </button>

        <div class="table-responsive">
            <div id="dt-opt_wrapper" class="dataTables_wrapper no-footer">
                
                <div id="dt-opt_filter" class="dataTables_filter"><label>Cari Barang:
                        ...
                        foreach ($barang as $row) {
                            ?>
                             <tr>
                                ...
                                <td>Rp <?php echo rupiah ($row->harga_pokok) ?></td>
                                <td>Rp <?php echo rupiah ($row->harga_jual) ?></td>
                                <td><?php echo $row->stok_barang?> Unit</td>
                                <td><?php echo $row->stok_minimal?> Unit</td>
                                <td><?php anchor('Barang/edit/'.$row->kd_barang,'Edit',array('class'=>'btn btn-info btn-rounded')) ?></td>
                                <td><?php anchor('Barang/Hapus/'.$row->kd_barang,'<i class="btn btn-warning btn-rounded swal-function">Hapus</i>') ?> </td>
                             </tr>
                             <?php
                            $no++;
                        }
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="harga_pokok" onkeypress="return hanyaAngka(event)" maxlength=10 class="harpok form-control" name="harga_pokok" placeholder="Harga pokok Rp..">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
