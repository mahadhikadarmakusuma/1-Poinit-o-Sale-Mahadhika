                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nama Barang</label><small class="text-normal">*Maximal 30 </small>
                                    <input type="text" class="form-control" maxlength="30" required="" value="<?php echo $edit['nama_barang'] ?>" name="nama_barang" placeholder="Nama BARANG...." >
                                </div>
                            </div>
                        </div>
                        <div class="row">
